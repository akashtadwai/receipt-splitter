...
describe('Results', () => {
    ...
    const mockCalculateReceiptTotal = jest.fn();
    ...
    const mockProps = {
        ...
        receiptData: [{ items: [] }], // Mock at least one receipt
        receiptPayers: {},
        setReceiptPayer: jest.fn(),
        personsList: ['Alice', 'Bob', 'Charlie'],
        calculateReceiptTotal: mockCalculateReceiptTotal.mockImplementation(() => 45.5)
    };

    beforeEach(() => {
        jest.clearAllMocks();
        mockCalculateCurrentTotal.mockImplementation(() => 45.5);
        mockCalculateReceiptTotal.mockImplementation(() => 45.5);
    ...
    it('handles zero amount display correctly', () => {
        ...
        render(<Results {...mockProps} results={resultsWithZero} />);
    ...
    it('generates correct receipt text', () => {
        ...
        expect(receiptText).toContain('Consumption Breakdown (Split):');
