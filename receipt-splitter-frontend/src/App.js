...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 p-4 md:p-8">
      ...
      <footer className="mt-10 pt-4 border-t border-indigo-100 text-center text-sm text-gray-500">
        <p className="flex items-center justify-center gap-2">
          🧠 Powered by Claude & Mistral AI ✨
          <a
            href="https://github.com/akashtadwai/receipt-splitter"
            target="_blank"
